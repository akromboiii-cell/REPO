...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8437152438:AAG2PNsPivU6D6Bcw4vrUwZnZ1UYsbUuCrA")
...
TARGETS = {
    "aslamboi": {
        ...
        "comment_text": "Aslamboi qalaysiz men addushi muhlisizman siz uc tashab bermaguningizcha postingizdagi kommentda hech bolmasa top ichida bolib yozaman tahrir qilmayman postni kutib otrganimni isboti soat hozir <real_time>",
    },
    "sardorgang": {
...
async def self_ping_once() -> None:
    """
    Agar SELF_URL berilgan bo'lsa, /ping ga bitta so'rov yuboradi.
    """
    if not SELF_URL:
        logging.info("SELF_URL berilmagan, ping o'tkazib yuborildi.")
        return
