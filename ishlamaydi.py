...
def admin_main_kb() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text="Foydalanuvchilar"), KeyboardButton(text="Cancel"), KeyboardButton(text="Ro'yxat hammasi 🎞️📺")]
...
# Agar aiosqlite importi yo'q bo'lsa fayl boshiga qo'shing:
# import aiosqlite
